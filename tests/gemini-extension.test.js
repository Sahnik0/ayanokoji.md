...
// always-on context, commands/*.toml for /ayanokoji + /ayanokoji-review, and
...
// carries the load-bearing rules — i.e. if the adapter stops wiring ayanokoji.
...
const EXTENSION_NAME = 'ayanokoji';
...
const REUSED_COMMANDS = ['commands/ayanokoji.toml', 'commands/ayanokoji-review.toml'];
const REUSED_SKILLS = ['skills/ayanokoji/SKILL.md'];
// Gemini CLI auto-loads this exact path for extension hooks. Ayanokoji's
...
test('manifest names the ayanokoji extension with a pinned version', () => {
...
test('contextFileName resolves to a file carrying the ayanokoji rules', () => {
  const manifest = loadManifest();
