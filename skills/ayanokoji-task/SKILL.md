...
name: ayanokoji-task
description: >
  Initialize a clean TASK.md template for a new task from the description in arguments.
  Use when the user wants to start a new task, "init task", "new task", "ayanokoji-task", or "/ayanokoji-task".
