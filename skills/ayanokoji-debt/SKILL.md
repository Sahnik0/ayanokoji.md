...
name: ayanokoji-debt
description: >
  Surfaces all deferred decisions, unresolved blockers, and [TO BE DEFINED]
  markers across the four scaffold files. Produces a prioritized debt ledger
  so deferrals never silently become permanent. One-shot report. Use when the
  user says "what's deferred", "show blockers", "ayanokoji-debt", or
  "/ayanokoji-debt".
argument-hint: ""
license: MIT
---
