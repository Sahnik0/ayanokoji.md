...
name: ayanokoji-gain
description: >
  Reads PROGRESS.md and produces a strategic progress summary: completed tasks,
  retry rate, protocol adherence, and open blocker count. Measures whether the
  Ayanokoji verification gate is being honored. One-shot display. Use when the
  user says "show progress", "how are we doing", "ayanokoji-gain", or
  "/ayanokoji-gain".
argument-hint: ""
license: MIT
---
