...
description: >
  Reviews the current TASK.md for strategic completeness: checks that the
  acceptance criterion is runnable, files in/out of scope are explicit, the
  approach has concrete numbered steps, and every risk has a fallback. One-shot
  report. Use when the user says "review this task", "check my plan",
  "ayanokoji-review", or "/ayanokoji-review".
argument-hint: ""
license: MIT
---
