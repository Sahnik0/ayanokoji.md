...
description: >
  Audits all four scaffold files (AGENTS.md, CONTEXT.md, TASK.md, PROGRESS.md)
  for protocol drift, staleness, and structural violations. One-shot report.
  Use when the user says "audit my scaffolds", "check our files",
  "ayanokoji-audit", or "/ayanokoji-audit".
argument-hint: ""
license: MIT
---
