...
name: ayanokoji-help
description: >
  Quick reference card for the Ayanokoji protocol: phases, commands, scaffold
  files, and behavioral contract. One-shot display. Use when the user says
  "help", "how does this work", "ayanokoji-help", or "/ayanokoji-help".
argument-hint: ""
license: MIT
---
