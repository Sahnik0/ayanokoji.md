...
description: >
  Show a consolidated strategic dashboard of current task, blockers, failures, and progress.
  Use when the user wants to check progress, status, "show status", "ayanokoji-status", or "/ayanokoji-status".
argument-hint: ""
license: MIT
---
