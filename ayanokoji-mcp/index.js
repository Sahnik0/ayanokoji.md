#!/usr/bin/env node
// Ayanokoji MCP server: serves the lazy-senior-dev ruleset over stdio as a
...
const server = new McpServer({ name: "ayanokoji", version: "0.1.0" });

const modeArg = z
  .enum(MODES)
  .optional()
  .describe("Ayanokoji intensity: lite, full, or ultra. Omit for the configured default.");

server.registerPrompt(
  "ayanokoji",
  {
    title: "Ayanokoji mode",
...
server.registerTool(
  "ayanokoji_instructions",
  {
    title: "Ayanokoji instructions",
    description: "Return the Ayanokoji ruleset for the given intensity (lite, full, or ultra).",
