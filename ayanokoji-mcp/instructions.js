// Pure instruction selection for the Ayanokoji MCP server. No MCP/SDK imports,
...
const { getAyanokojiInstructions } = require("../hooks/ayanokoji-instructions.js");
const { getDefaultMode, normalizeMode } = require("../hooks/ayanokoji-config.js");
...
// ayanokoji: keep the surface to these three; "off"/"review" aren't served here.
...
export function buildInstructions(requested) {
  return getAyanokojiInstructions(resolveMode(requested));
}
