# Caveman vs Ayanokoji — 2026-06-12
...
## Ayanokoji v1 (before this benchmark)

| Task | Baseline | Caveman | Ayanokoji v1 |
|---|---|---|---|
...
1. Code minimalism: ayanokoji dominated (2.2× fewer lines than caveman, 5.5× fewer than baseline).
2. Total tokens: caveman won by ~4% — ayanokoji wrote minimal code, then long
   "skipped on purpose" essays. Prose ate the code savings.
3. Speed: caveman 136s vs ayanokoji 228s — ayanokoji deliberated about what not to build.
4. Floor effect: on already-minimal tasks (csv-sum) both skills pay ~3k tokens
   skill-read tax over baseline.

## Ayanokoji v2 (after fixes)
...
| Task | Ayanokoji v2 | Δ vs v1 | Δ vs caveman |
|---|---|---|---|
...
## Ayanokoji v3 (skill file compressed)
...
| Task | Ayanokoji v3 | Δ vs v2 | Δ vs caveman |
|---|---|---|---|
...
| Area | Winner |
|---|---|
| Code size | **Ayanokoji** — 47 vs 117 lines (2.5×) |
| Deliverable prose | **Ayanokoji** — capped at 3 skip-lines, under caveman's gotcha lists |
| Total tokens (cost) | **Ayanokoji** — 135.7k vs 138.4k (−2.0%) |
| Wall time | **Ayanokoji** — 127s vs 136s (−7%; n=1, treat as parity-or-better) |
| Follow-up prevention | **Ayanokoji** — every skip names its escalation trigger |
